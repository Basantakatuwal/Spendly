...
- Run 'git diff' for unsatged changes
...
Both subagents must run in parallel. Do not wait for one to finish before starting the order.
...
- If either subagents fails or returns no output, report it and do not present a partial review as complete
